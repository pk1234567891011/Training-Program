...
<body>
  ...
  <div id="third">
  <button id="Create_link"><a href="create_product.php" style="color: white; font-weight: bold; text-decoration: none;font-size: 18px">Create Product</a></button>
...
<div>
  <form name="bulk_action_form" action="" method="post" onSubmit="return delete_confirm();"/>
   ...
   if($page>1){
    echo"<a href='list_product.php?page=".($page-1)."'class='pagination'> first </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   if($i==$total_page)
   {
    echo"<a href='list_product.php?page=".($total_page)."'class='pagination'> Last </a>&nbsp;&nbsp;";
