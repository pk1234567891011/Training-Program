...
<?php
            ...
            $num_per_page=3;
            $start_from=($page-1)*3;
            $query="select * from products order by PID DESC limit $start_from,$num_per_page";            $result=mysqli_query($db,$query);
 ?>
<!DOCTYPE html>
<html>
<head>
      ...
      <tbody>
              ...
              while ($fetch=mysqli_fetch_assoc($result)) {
                ...
                ?>
                   ...
                   <td><?php 
                   #$category="SELECT C_name from categories WHERE ID=$CID ";
