    ...
    <form method="POST" action="#" name="myform" enctype="multipart/form-data">
      <div id="content" >
          ...
          <div id="up_div">
           ...
           <input type="submit"  value="submit" style="background-color: #ace600; height: 60px; width: 220px; margin-left: 262px; margin-top: 425px; border-radius: 5px; color: white" name="submit" onclick="return validateform()" >
          </div>

          <label id="select">Select Category</label>
          <select name="category" class="select_category" id="cate">
