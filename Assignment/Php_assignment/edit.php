...
if (isset($_POST['update'])) {
    ...
    if (empty($name)) {
        ...
        $result = mysqli_query($db, "UPDATE categories SET C_name='$name' WHERE ID=$ID");
        session_start();
...
<body>
  ...
  <div id="second">
    <span id="txt_create">Edit Category</span>
  </div>
  <div id="third">
    <form method="POST" action="edit.php">
      <div id="content" >
      <label id="lbl_category">Category Name</label>
      <input type="text" name="category" id="txt_category" value="<?php echo $name; ?>">
      <span id="p_fail">
               <?php
if (isset($msg)) {
    echo $msg;
...
?>
      ...
      <hr id="line" width="740" style="border: 1px solid #cacbcd" color="#cacbcd" size="6" >
       ...
       <input type="submit" name="update" value="Update" style="background-color: #ace600; height: 60px; width: 200px; margin-left: 283px; margin-top: 134px; border-radius: 5px; color: white"  >
      </div>
