...
{   if($check !== false){
        ...
        $result = mysqli_query($db, "UPDATE products SET name='$name',price=$price,category='$category',image='$imgContent' WHERE PID=$PID");
...
margin-top: 416px; border-radius: 5px; color: white"  > 
          </div>
